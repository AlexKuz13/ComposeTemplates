...
object CustomActivityTemplate: Template {
    ...
    override val recipe: Recipe
        get() = {
            customActivityRecipe(it as ModuleTemplateData, activityClass.value, isLauncher.value, generateLayout.value,
                addHilt.value, layoutName.value, packageName.value)
        }
    override val uiContexts: Collection<WizardUiContext>
        get() = listOf(WizardUiContext.MenuEntry, WizardUiContext.NewProject, WizardUiContext.NewProjectExtraDetail, WizardUiContext.NewModule)
    ...
    override fun thumb(): Thumb {
        return Thumb { findResource(this.javaClass, File("thumbs/Avatar.jpeg")) }
    }
}